...
import static com.songsociety.web.rest.TestUtil.sameInstant;
...
import com.songsociety.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().date(DEFAULT_DATE).content(DEFAULT_CONTENT);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().date(UPDATED_DATE).content(UPDATED_CONTENT);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.date(UPDATED_DATE).content(UPDATED_CONTENT);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.date(UPDATED_DATE).content(UPDATED_CONTENT);
